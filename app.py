...
Original file is located at
    https://colab.research.google.com/drive/1QtoGV46oUAijHo6tLpeB74c6avTTxXvp
"""

!pip install streamlit pyngrok mplsoccer

from pyngrok import ngrok

# Cole seu token aqui
NGROK_AUTH_TOKEN = "2wC7ydOlgSaliUemWkvASCY3eYJ_n3wE5Vjsa6z7h3p3xMr3"
...
csv_path = '/content/drive/MyDrive/Streamlit/BRA25 (3).csv'
icon_path = '/content/DataFutebol-Photoroom.png'

import shutil

shutil.copy(csv_path, 'BRA25.csv')
shutil.copy(icon_path, 'df.png')



import pandas as pd
df = pd.read_csv("BRA25.csv")
df.to_parquet("BRA25.parquet", index=False)
...
# Aguarda o app iniciar e conecta
time.sleep(5)
public_url = ngrok.connect(8501)
print("🔗 Acesse o site em:", public_url)


#Histórico de Confrontos e Equipe: Retirar as colunas inutéis, deixar apenas o placar, os times, a data, o H/A, e o resultado.
#No CHB, quando aparece a visão de por time, não faz o filtro corretamente. Na parte de abaixo dos recordes de gols e etc, não está aparecendo nada.
#Nos gráficos, também não está aparecendo.